           ...
           <table align="center" width="100%">
            <tr>
                <td align="left">
                    ...
                    <span style="font-family: 'Agency FB'; font-size: 42px">Welcome&nbsp;<span style="color:#800000"><%=session.getAttribute("uname").toString()%></span></span></td>
            </tr>
        </table>
        ...
        <tr>
            <td style="width: 53px">
                ...
                <td>
                    ...
                    <a href="type.jsp">Post a new Query</a>
    </td>
        </tr>
        <tr>
            <td style="width: 53px">
                ...
                <td>
                    ...
                    <a href="view_preq.jsp">view previously posted queries</a>
    </td>
        </tr>
        <tr>
            <td colspan="2">
