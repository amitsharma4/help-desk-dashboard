<%-- 
    Document   : team.jsp
    Created on : Oct 4, 2012, 4:11:29 PM
    Author     : poonam
--%>
...
<div id="ourCompany-bg">
	...
	<div id="ourCompany-part">
            ...
            <tr>
                <td align="left">
                    ...
                    <img src="images/a.jpg" Height="20px" Width="20px"/>&nbsp;
                    <img src="images/a.jpg" Height="20px" Width="20px"/>&nbsp;
                    <span style="font-family: 'Agency FB'; font-size: 42px"> meet the
                    <span style="color: #800000">team</span></span></td>
            </tr>
        </table>
        <hr />
        <br />
    ...
    <table style="width: 650px">
        ...
        <tr>
            <td><img src="images/anshul.jpg"/></td>
            <td align="right" style="width: 468px">
                Anshul Tiwari<br>
                MCA Vth Sem.<br>
                +91-9414906868
               
                <asp:Label ID="Label1" runat="server" BackColor="Maroon" ForeColor="White" 
                    Text="Team Member"></asp:Label>
            </td>
        </tr>
    </table>
    ...
    <table style="width: 650px">
        ...
        <tr>
            <td align="right" style="width: 510px">
                <asp:Label ID="Label3" runat="server" BackColor="Maroon" ForeColor="White" 
                    Text="Team Member"></asp:Label>
            </td>
        </tr>
    </table>
