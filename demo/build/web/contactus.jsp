<%-- 
    Document   : contactus
    Created on : Oct 3, 2012, 10:39:31 PM
	...
	<div id="ourCompany-part">
            ...
            <tr>
                <td align="left">
                    ...
                    <span style="font-family: 'Agency FB'; font-size: 42px">contact
                        <span style="color: #800000">us</span></span></td>
            </tr>
        </table>
        <hr />
        <br />
    ...
    <table style="width: 100%">
        <tr>
            <td>
                ...
                <br />
                At IT Help Desk, we are 
                always looking forward to hear from you. If you have any questions, 
                <br />
                comments,
                suggestions for us please send them to </span>
                <a href="mailto:queries@ithelpdesk.com" style="font-size: medium">queries@ithelpdesk.com</a><span 
                    style="font-family: Arial"> on email.</span></td>      
        </tr>
        ...
        <tr>
            <td>
                ...
                <span style="font-family: Arial; font-weight: bold; font-size: small;">You can also write in to us at:</span>
        ...
        <tr>
            <td style="color: #800000; font-family: Arial">
                
                <b>
                <br />
                IT Help Desk<br />
                <br />
                </b><span style="color: #000000; font-size: medium">Global Broadcast News, 
                Express Trade Tower,<br />
                <br />
                Plot No. 15-16, Sector-4, Udaipur, Rajasthan,<br />
                <br />
                India - </span><span style="color: #000000">201301</span></td>
        </tr>
        ...
        <tr>
            <td>
                ...
                <br />
                Contact:</b></span>
                <span style="font-family: Arial">9784762183, 8233328178</span></td>
        </tr>
    </table>
