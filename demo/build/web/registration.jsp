<%-- 
    ...
    Created on : Dec 7, 2012, 8:26:51 PM
    Author     : Shri Ram
--%>
...
<body>
<form id="abc" runat="server" name="frm" action ="reg" method="get" onsubmit="return validate();">
	...
	<div>
        ...
        <tr>
            <td style="font-size: small; width: 211px; height: 32px;">
                Category:</td>
            <td>
                <input type="radio" name="a" value="networking">Networking&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio" name="a" value="hardware">Hardware&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio" name="a" value="coding">Coding&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
                <input type="radio" name="a" value="testing">Testing&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio" name="a" value="database">Database&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio" name="a" value="operating system">Operating System
            </td>
        </tr>
